...
OhdsiRTools::checkUsagePackage("readmission")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/readmission.pdf")
shell("R CMD Rd2pdf ./ --output=extras/readmission.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("readmission")
