...
Vignette: [Using the package skeleton for patient-level prediction studies](https://raw.githubusercontent.com/OHDSI/StudyProtocolSandbox/master/readmission/inst/doc/UsingSkeletonPackage.pdf)
...
outputFolder <- "./readmissionResults"
...
```r
  ...
  devtools::install_github("OHDSI/StudyProtocolSandbox/readmission")
```
