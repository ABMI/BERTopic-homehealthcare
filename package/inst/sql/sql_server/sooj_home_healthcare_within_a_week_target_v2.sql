...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (262,9201,32037,9203)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (262,9201,32037,9203)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4236026,4246074,4295046,2721443)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4236026,4246074,4295046,2721443)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4257833,4251584,4030023)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4257833,4251584,4030023)
  and c.invalid_reason is null
...
WHERE DATEDIFF(d,C.visit_start_date, C.visit_end_date) >= 2
...
) A on A.person_id = P.person_id  AND A.START_DATE >= P.OP_START_DATE AND A.START_DATE <= P.OP_END_DATE AND A.START_DATE >= DATEADD(day,0,P.END_DATE) AND A.START_DATE <= DATEADD(day,0,P.END_DATE) ) cc on p.person_id = cc.person_id and p.event_id = cc.event_id
...
) A on A.person_id = P.person_id  AND A.START_DATE >= P.OP_START_DATE AND A.START_DATE <= P.OP_END_DATE AND A.END_DATE >= DATEADD(day,-7,P.START_DATE) AND A.END_DATE <= DATEADD(day,-1,P.START_DATE) ) cc 
